# This Module extends icrawler.builtin.GoogleImageCrawler because it has to download only
# .jpg files, and the original too crawls .png files.

# view source on https://github.com/hellock/icrawler/issues/98
import datetime
import json
import re
